...
setup(name=NAME,
      ...
      install_requires=["tensorflow==1.15.4","keras==2.3.0","keras-resnet==0.1.0","h5py","matplotlib","opencv-python","Pillow","pandas","pyyaml","progressbar2","six","scipy","slidingwindow","tqdm","xmltodict"],
